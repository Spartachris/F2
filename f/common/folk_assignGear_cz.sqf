...
_bagmedium = "ACE_BackPack_ACR";		// 8+ slots																							// Backpack for assistant gunners (AAR, AMMG, AMAT, AHAT), so that they don't have to drop ammo themselves
_baglarge =  "ACE_BackPack_ACR"; 		// 12+ slots
...
// ====================================================================================					
// ACE SPECIFCS																		
_bagmedic = "ACE_Rucksack_MOLLE_Brown_Medic";
